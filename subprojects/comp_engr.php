<?php 
	...
	$projects =  $getFromP->getCompEngrCourse();
	//var_dump($project);
?>
...
<div class="col-md-12">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Computer Engineer Project Topics</li>
		</ol>
	</nav>
</div> 
...
<div class="col-md-12">
	<div class="hero-txt white-color">
		...
		<!-- Title -->
		<h3 class="h3-xs">Computer Engineer Projects for Final Year Students</h3>
...
<div class="col-md-12">
	<div class="section-title mb-40">
		...
		<!-- Title 	-->	
		<h4 class="h4-xl">COMPUTER ENGINEER PROJECTS WITH DOCUMENTATION, SOURCE CODES+APPLICATIONS/SOFTWARE </h4>
		<!-- Text -->	
		<p class="p-md">Below are Computer Engineer Project Topics with available Chapters 1-4. Click on any to preview its Contents.</p>
	</div>	
</div>
</div>
